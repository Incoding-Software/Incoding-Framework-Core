...
namespace Incoding.Data
{
    ...
    public abstract class AdHocFetchSpecificationBase<TEntity> where TEntity: class
    {
        #region Fields

        public readonly List<Func<IQueryable<TEntity>, IQueryable<TEntity>>> applies = new List<Func<IQueryable<TEntity>, IQueryable<TEntity>>>();
        ...
        {
            return this.IsReferenceEquals(obj) && Equals(obj as AdHocFetchSpecificationBase<TEntity>);
        }
        ...
        /// 
        protected bool Equals(AdHocFetchSpecificationBase<TEntity> other)
        {
