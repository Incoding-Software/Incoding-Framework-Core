    ...
    public class ConditionalIs : ConditionalBase
    {
        ...
        void SetUnary(UnaryExpression expression)
        {
            ...
            else
            {
                ...
                Set(valueOperand, expression.NodeType != ExpressionType.Not, EnumExtensions.ToStringLower(ExpressionType.Equal));
            }
        }
        ...
        void SetBoolean(Expression expression)
        {
            ...
            Set(true, value, EnumExtensions.ToStringLower(ExpressionType.Equal));
        }
        ...
        void SetBinary(BinaryExpression expression)
        {
            ...
            Set(GetValue(expression.Left, this.fakeMode), GetValue(expression.Right), EnumExtensions.ToStringLower(expression.NodeType));
        }
