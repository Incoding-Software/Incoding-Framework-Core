...
namespace Incoding.Mvc.MvcContrib.Incoding_Meta_Language.Selectors.Jquery
{
    ...
    public class JquerySelector : Selector
    {
        ...
        public JquerySelectorExtend Expression(JqueryExpression expression)
        {
            ...
            else
            {
                foreach (var exist in Enum.GetValues(typeof(JqueryExpression))
                    ...
                    AlsoSelector(":{0}".F(EnumExtensions.ToJqueryString((Enum) exist)));
            }
        ...
        {
            return Id(expressions.Select(r => ReflectionExtensions.GetMemberNameAsHtmlId((LambdaExpression) r))
                                 .ToArray());
        }
        ...
        {
            return Name(expressions.Select(r => ReflectionExtensions.GetMemberName((LambdaExpression) r))
                                   .ToArray());
        }
