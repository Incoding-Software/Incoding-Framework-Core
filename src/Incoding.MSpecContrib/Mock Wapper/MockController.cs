namespace Incoding.MSpecContrib
{
    ...
    public class MockController<TController> where TController : IncControllerBase
    {
        ...
        public void ShouldBeRenderModel<TModel>(Action<TModel> action, string viewName = "Action")
        {
            ...
            viewEngine.Verify(r => r.FindPartialView(Pleasure.MockIt.IsAny<ControllerContext>(), viewName, Pleasure.MockIt.IsAny<bool>()));
        }
        ...
        void AddViewEngine()
        {
            ...
            viewEngine.Setup(r => r.FindPartialView(Pleasure.MockIt.IsAny<ControllerContext>(), Pleasure.MockIt.IsAny<string>(), Pleasure.MockIt.IsAny<bool>())).Returns(new ViewEngineResult(view.Object, viewEngine.Object));
