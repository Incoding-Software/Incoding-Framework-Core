namespace Incoding.UnitTest.MSpecGroup
{
    ...
    public class When_mock_controller_with_inc_partial_view : Context_mock_controller
    {
        #region Fake classes
        ...
        protected class FakeController : IncControllerBase
        {
            ...
            public IncodingResult FakeMethod()
            {
                ...
                return IncPartialView("ViewName", 10);
        ...
        It should_be_render = () => mockController.ShouldBeRenderModel(10, "ViewName");
