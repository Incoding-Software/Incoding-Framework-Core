        ...
        It should_be_time_with_date_and_date = () =>
                                               {
                                                   ...
                                                   time.ShouldBeTime(new DateTime(2006, 2, 5, time.Hour, time.Minute, time.Second, time.Millisecond));
                                               };
        ...
        It should_be_time_with_time_span_and_time_span = () =>
                                                         {
                                                             ...
                                                             timeSpan.ShouldBeTime(new TimeSpan(timeSpan.Hours, timeSpan.Minutes, timeSpan.Seconds));
                                                         };
